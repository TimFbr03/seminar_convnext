...
def run_epoch(net, loader, criterion, optimizer, device):
    ...
    with torch.set_grad_enabled(training):   # <-- ein Aufruf deckt beide Fälle
...
def train_vit():
    ...
    for epoch in tqdm(range(NUM_EPOCHS), desc="Epochs"):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(net.state_dict(), DATA_DIR / "best_vit.pt")
    ...
    net.load_state_dict(torch.load(DATA_DIR / "best_vit.pt", weights_only=True))
